    ...
    <div className="bg-slate-50">
        ...
        sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit"
          >
            ...
            hidden sm:block lg:hidden xl:block"
              ...
              <img
                src="/line.png"
                className="absolute w-20 -left-6 -bottom-6 seelct-none"
              />
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          >
            <div className="flex flex-auto flex-col items-center gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  &quot;The case feels durable and I even got a complement on
